...
while first != 'End of game':               # program should end on "End of game or when there was a number war"
    ...
    first = input()
    # add string input statement for the first points to avoid conversion issues and to ensure the loop ends
...
while not score_range == 'bullseye':              # program should end when someone hits the bullseye
    ...
    score_range = input()
    # add string input statement to avoid conversion issues and to ensure the loop ends
