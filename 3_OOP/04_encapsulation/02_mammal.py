...
Create a class attribute called kingdom,
* which should not be accessed outside the class and set it to be "animals".
...
class Mammal:
    __kingdom = "animals"    # set a private class attribute
