...
class Zoo:
    ...
    def add_animal(self, animal: Animal, price):
        if price <= self.__budget and self.__animal_capacity > len(self.animals):
            ...
            # return the class of the inherited class
    ...
    def tend_animals(self):
        care = sum([a.money_for_care for a in self.animals])
    ...
    def animals_status(self):
        animals = len([a.name for a in self.animals])
        lions = [a for a in self.animals if a.__class__.__name__ == 'Lion']
        tigers = [a for a in self.animals if a.__class__.__name__ == 'Tiger']
        cheetahs = [a for a in self.animals if a.__class__.__name__ == 'Cheetah']

        result = f'You have {animals} animals\n'
    ...
    def workers_status(self):
        workers = len([w.name for w in self.workers])
        keepers = [w for w in self.workers if w.__class__.__name__ == 'Keeper']
        caretakers = [w for w in self.workers if w.__class__.__name__ == 'Caretaker']
        vets = [w for w in self.workers if w.__class__.__name__ == 'Vet']

        result = f'You have {workers} workers\n'
